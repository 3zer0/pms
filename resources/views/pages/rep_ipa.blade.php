	...
	<div class="toolbar py-3 pb-lg-10" id="kt_toolbar">
		<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
			<div class="page-title d-flex flex-column me-3">
				<h1 class="d-flex text-white fw-bold my-1 fs-3">Inventory per Account</h1>
				<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-1">
					...
					<li class="breadcrumb-item text-white opacity-75">Inventory per Account</li>
				</ul>
			</div>
        ...
        <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
            <div class="page-title d-flex me-3 row w-100">
                ...
                <div class="form-group me-3 align-self-end col-lg-2" id="ipaExportContainer">
                    ...
                    <a href="javascript:void(0);" class="btn btn-icon btn-success" id="printBtn" data-action="gen-ipa">
                        <i class="fas fa-marker text-white fs-3"></i>
                    </a>
                    <a href="javascript:void(0);" class="btn btn-icon btn-danger" id="printBtn" data-action="clr-ipa">
                        <i class="fas fa-ban text-white fs-3"></i>
                    </a>
                    <a href="javascript:void(0);" class="btn btn-icon btn-primary" id="printBtn" data-action="print-ipa">
                        <i class="fas fa-print text-white fs-3"></i>
                    </a>
                    <a href="javascript:void(0);" class="btn btn-icon btn-warning" id="excelBtnIpa" data-action="dl-ipa">
			...
			<div class="card">
				<div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table align-middle table-row-bordered fs-7 gy-3" id="ipa-tbl">

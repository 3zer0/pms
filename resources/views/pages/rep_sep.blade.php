	...
	<div class="toolbar py-3 pb-lg-10" id="kt_toolbar">
		<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
			<div class="page-title d-flex flex-column me-3">
				<h1 class="d-flex text-white fw-bold my-1 fs-3">Report on the Physical Count of Semi-Expendable Property</h1>
				<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-1">
					...
					<li class="breadcrumb-item text-white opacity-75">RPCSEP</li>
				</ul>
			</div>
            ...
            <div class="page-title d-flex me-3 row w-100">
                ...
                <div class="form-group me-3 col-lg-6">
                    ...
                    <select class="form-select form-select-solid" name="category_id" data-control="select2" data-placeholder="Select" id="category_id">
                        <option value=""></option>
                        @php
                            $category = App\Models\Category::where('type', 'ICS')->get(['id', 'category_name', 'type']);
                        @endphp
                ...
                <div class="form-group me-3 align-self-end col-lg-2" id="ipaExportContainer">
                    ...
                    <a href="javascript:void(0);" class="btn btn-icon btn-success" id="genBtnSep" data-action="gen-sep">
                        <i class="fas fa-marker text-white fs-3"></i>
                    </a>
                    <a href="javascript:void(0);" class="btn btn-icon btn-danger" id="clrBtnSep" data-action="clr-sep">
                        <i class="fas fa-ban text-white fs-3"></i>
                    </a>
                    <a href="javascript:void(0);" class="btn btn-icon btn-primary" id="printBtnSep" data-action="print-sep">
                        <i class="fas fa-print text-white fs-3"></i>
                    </a>
                    <a href="javascript:void(0);" class="btn btn-icon btn-warning" id="excelBtnSep" data-action="dl-sep">
			...
			<div class="card">
				<div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table align-middle table-row-bordered fs-7 gy-3" id="sep-tbl">

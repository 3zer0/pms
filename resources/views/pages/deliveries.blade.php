	...
	<div class="toolbar py-5 pb-lg-10" id="kt_toolbar">
		<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
			<div class="page-title d-flex flex-column me-3">
				<h1 class="d-flex text-white fw-bold my-1 fs-3">New Deliveries</h1>
				<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-1">
					...
					<li class="breadcrumb-item text-white opacity-75">New Delivery</li>
				</ul>
			</div>
			<div class="d-flex align-items-center py-3 py-md-1">
				<a href="javascript:void(0);" data-bs-theme="light" class="btn bg-body btn-active-color-primary" data-bs-toggle="modal" data-bs-target="#deliveryModal">Add Delivery</a>
			</div>
		</div>
	</div>
			...
			<div class="card">
				<div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table align-middle table-row-bordered fs-7 gy-3" id="delivery-tbl">
...
@section('scripts')
    ...
    <script src="assets/js/custom/pages/admin/deliveries-dt.js?{{ Str::random(12) }}"></script>
@endsection

	...
	<div class="toolbar py-3 pb-lg-10" id="kt_toolbar">
		<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
			<div class="page-title d-flex flex-column me-3">
				<h1 class="d-flex text-white fw-bold my-1 fs-3">Property Card</h1>
				<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-1">
					...
					<li class="breadcrumb-item text-white opacity-75">Property Card</li>
				</ul>
			</div>
            ...
            <div class="page-title d-flex me-3 row w-100">
                ...
                <div class="form-group me-3 col-lg-6">
                    ...
                    <select class="form-select form-select-solid" name="category_id" data-control="select2" data-placeholder="Select" id="category_id">
                        <option value=""></option>
                        @php
                            $category = App\Models\Category::get([ 'id', 'category_name', 'type' ]);
                        @endphp
                ...
                <!-- Generate Button -->
                <div class="form-group me-3 align-self-end col-lg-2" id="pcExportContainer">
                    ...
                    <a href="javascript:void(0);" class="btn btn-icon btn-success" id="printBtnPc" data-action="gen-pc">
                        <i class="fas fa-marker text-white fs-3"></i>
                    </a>
                    <a href="javascript:void(0);" class="btn btn-icon btn-danger" id="printBtnPc" data-action="clr-pc">
                        <i class="fas fa-ban text-white fs-3"></i>
                    </a>
                    <a href="javascript:void(0);" class="btn btn-icon btn-primary" id="printBtnPc" data-action="print-pc">
                        <i class="fas fa-print text-white fs-3"></i>
                    </a>
                    <a href="javascript:void(0);" class="btn btn-icon btn-warning" id="excelBtnPc" data-action="dl-pc">
			...
			<div class="card">
				<div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table align-middle table-row-bordered fs-7 gy-3" id="pc-tbl">

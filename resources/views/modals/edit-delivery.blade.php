...
<div class="modal fade" id="editDeliveryModal" tabindex="-1" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false" data-bs-focus="false">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header pb-4" id="editDeliveryModal_header">
                <h4>Delivery</h4>
            ...
            <form id="editDeliveryForm">
                <div class="modal-body px-9 py-3">
                    ...
                    @csrf
                    <div class="scroll-y me-n7 pe-7" id="editDeliveryModal_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="600px" data-kt-scroll-dependencies="#editDeliveryModal_header" data-kt-scroll-wrappers="#editDeliveryModal_scroll">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="pe-5">
                                    <div class="d-flex align-items-center bg-light rounded mb-5 p-3">
                                        ...
                                        <div class="text-gray-900 fw-bold fs-6">Update Delivery Information </div>
                                    </div>

                                    <div class="fv-row mb-5">
                                        <div class="form-floating">
                                            <select class="form-select form-select-solid form-select-sm" name="supplier_id" data-control="select2" data-placeholder="Select" id="supplier_id">
                                                <option value=""></option>
                                                @php $supplier = App\Models\Supplier::get([ 'id', 'supplier_name' ]); @endphp
                                    ...
                                    <div class="row">
                                        <div class="d-flex align-items-center bg-light rounded mb-5 p-3">
                                            <i class="ki-duotone ki-user-edit fs-1 mx-3 text-primary"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i>
                                            <div class="text-gray-900 fw-bold fs-6">Requesting Information </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="fv-row mb-5">
                                                <div class="form-floating">

...
<div class="modal fade" id="addItemModal" tabindex="-1" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false" data-bs-focus="false">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header pb-4" id="addItemModal_header">
            ...
            <div id="kt_docs_repeater_basic">
                <form id="addItemForm" action="{{ route('item.create') }}">
                    <div class="modal-body px-9 py-3">
                        <div class="text-end required fst-italic fs-7 mb-3">Denotes required field</div>
                        @csrf
                            <div class="scroll-y me-n7 pe-7" id="addItemModal_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="600px" data-kt-scroll-dependencies="#addItemModal_header" data-kt-scroll-wrappers="#addItemModal_scroll">
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="pe-5">
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="fv-row mb-5">
                                                        <div class="form-floating">
                                                            <select class="form-select form-select-solid form-select-sm" name="delivery_id" data-control="select2" data-placeholder="Select" id="delivery_id">
                                                                <option value=""></option>
                                                                @php $delivery = App\Models\Delivery::where('del_quantity', '!=', DB::raw("item_count"))->get([ 'id', 'ref_no' ]); @endphp
                                                                @foreach ($delivery as $d)
                                                                    <option value="{{ $d->id }}">{{ $d->ref_no }}</option>
                                                                @endforeach
                                                            </select>
                                                            <label for="delivery_id">Reference No. <span class="text-danger">*</span></label>
                                                        </div>
                                                    </div>
                                                </div>
                                            {{-- </div>
                                            ...
                                            <div class="row"> --}}
                                                {{-- <div class="col-lg-2">
                                                    <div class="fv-row mb-5">
                                                        <div class="form-floating">
                                                            <input type="text" class="form-control form-control-solid" name="item_quantity" id="item_quantity" placeholder=""/>
                                                            <label for="item_quantity" class="required">Quantity</label>
                                                        </div>
                                                    </div>
                                                </div> --}}
                                                <div class="col-lg-3">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="fv-row mb-5">
                                                        <div class="form-floating">
                                                            ...
                                                            <label for="officeServicesItems">Office/Bureau/Services <span class="text-danger">*</span></label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="fv-row mb-5">
                                                        <div class="form-floating">
                                                            ...
                                                            <label for="officeDivisionItems">Divsion <span class="text-danger">*</span></label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>

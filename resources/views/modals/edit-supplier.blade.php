...
<div class="modal fade" id="editSupplierModal" tabindex="-1" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false" data-bs-focus="false">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header pb-4" id="editSupplierModal_header">
                <h4>Supplier</h4>
            ...
            <form id="editSupplierForm">
                <div class="modal-body px-9 py-3">
                    ...
                    @csrf
                    <div class="scroll-y me-n7 pe-7" id="editSupplierModal_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="600px" data-kt-scroll-dependencies="#editSupplierModal_header" data-kt-scroll-wrappers="#editSupplierModal_scroll">
                        <div class="row">
                            <div class="col-lg-12">

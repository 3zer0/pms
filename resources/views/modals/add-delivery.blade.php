...
<div class="modal fade" id="deliveryModal" tabindex="-1" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false" data-bs-focus="false">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header pb-4" id="deliveryModal_header">
                <h4>Delivery</h4>
            ...
            <form id="deliveryForm" action="{{ route('delivery.create') }}">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="pe-5">
                                    <div class="d-flex align-items-center bg-light rounded mb-5 p-3">
                                        ...
                                        <div class="text-gray-900 fw-bold fs-6">Delivery Information </div>
                                    </div>

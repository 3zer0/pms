    ...
    <div class="container" size="A4" style="font-family: 'Times New Roman', serif;">
        <div class="print-area" style="background-color: white; width: 215.9mm; margin: auto; position: relative;">
            ...
            <table style="width: 100%; font-size: 9pt;">
                <tr>
                    <td style="text-align: right; vertical-align: center; width: 15%;"><i>Appendix 76 </i></td>
                </tr>
            </table>
            ...
            {{-- <table style="border: 1px solid black;  border-top: none; width: 100%; font-size: 9pt;">
                <tbody style="padding: 5px;">
                    <tr>
                        <td colspan="2" style="text-align: left; vertical-align: center; padding: 5px; border-spacing: 0px;"><b>Transfer Type: (check only one)</b></td>
                    </tr>
                    <tr>
                        <td style="text-indent: 100px; vertical-align: center; width: 50%; border-spacing: 0px; padding: 0;">
                            <input type="checkbox" name="select_row[]" value="{{ $trans->id }}" style="margin: 0; line-height: 1; height: 15px;">
            ...
            <table style="border: 1px solid black; border-collapse: collapse; border-top: none; width: 100%; font-size: 9pt;">
                <thead>
                    <tr>
                        <td style="border: 1px solid black;  border-top: none; text-align: center; padding: 5px; font-weight: bold; border-spacing: 0px; width: 15%;">Date Acquired</td>
                        <td style="border: 1px solid black;  border-top: none; text-align: center; padding: 5px; font-weight: bold; border-spacing: 0px; width: 15%;">Property No.</td>
                        <td style="border: 1px solid black;  border-top: none; text-align: center; padding: 5px; font-weight: bold; border-spacing: 0px; width: 40%;">Description</td>
                        <td style="border: 1px solid black;  border-top: none; text-align: center; padding: 5px; font-weight: bold; border-spacing: 0px; width: 15%;">Amount</td>

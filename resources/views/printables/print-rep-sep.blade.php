...
<head>
    ...
    <title>PRINT - RCPSEP</title>

    <style>
        @media print {
            @page {
                size: A4 portrait; /* Set to portrait orientation */
                margin: 10mm;      /* Set margin as needed */
            }
            ...
            /* Adjust the width and height for portrait layout */
            .print-area {
                background-color: white;
                width: 210mm; /* Full width for A4 portrait */
                height: 297mm; /* Full height for A4 portrait */
                margin: 0;
...
<body>
    <div class="container" size="A4">
        {{-- <div class="print-area" style="background-color: white; width: 215.9mm; margin: auto; position: relative;">
            ...
            <table style="border: 1px solid black; border-collapse: collapse; table-layout: fixed; width: 100%; font-size: 7pt;">
                <thead>
                    <tr>
                ...
                <tbody>
                    @if($isMultipleItems)
                        ...
                        <tr>
                            ...
                            <td style="border: 1px solid black;  text-align: center; padding: 5px; border-spacing: 0px;">{{ $i->employee->fullname }}<br>{{ $i->divab }}</td>
                        </tr>
                        @endforeach
                    @else
                        <tr>
                            <td style="border: 1px solid black;  text-align: center; padding: 5px; border-spacing: 0px;">{{ $items->first()->article_name }}</td>
                            <td style="border: 1px solid black;  text-align: right; padding: 5px; border-spacing: 0px;">{{ $items->first()->description }}</td>
                            <td style="border: 1px solid black;  text-align: left; padding: 5px; border-spacing: 0px;">{{ $items->first()->property_no }}</td>
                            <td style="border: 1px solid black;  text-align: left; padding: 5px; border-spacing: 0px;">{{ $items->first()->unit_of_measure }}</td>
                            <td style="border: 1px solid black;  text-align: center; padding: 5px; border-spacing: 0px;">{{ '₱' . number_format($items->first()->purchase_price, 2) }}</td>
                            <td style="border: 1px solid black;  text-align: center; padding: 5px; border-spacing: 0px;">1</td>
                            <td style="border: 1px solid black;  text-align: center; padding: 5px; border-spacing: 0px;">1</td>
                            <td style="border: 1px solid black;  text-align: center; padding: 5px; border-spacing: 0px;">0</td>
                            <td style="border: 1px solid black;  text-align: center; padding: 5px; border-spacing: 0px;">0.00</td>
                            <td style="border: 1px solid black;  text-align: center; padding: 5px; border-spacing: 0px;">{{ $items->first()->employee->fullname }}<br>{{ $items->first()->divab }}</td>
                        </tr>
                    @endif
                </tbody>
            </table>
                ...
                <tbody>
                    <tr style="height: 5em">
                        <td colspan="2" style="vertical-align: top; padding: 0.25em; border: none;">
                            ...
                            <div style="text-align: left; text-indent: 2em; margin-top: 3em;">
                            ...
                            <div style="text-align: left; text-indent: 2em;">
                                <span style="font-weight: normal; font-size: 8pt;">{{ $employees->position ?? 'n/a' }}, {{ $userId->jurisdiction->division->division_name }}</span>
                            </div>
                        </td>
                        <td colspan="2" style="vertical-align: top; padding: 0.25em; border: none;">
                            ...
                            <div style="text-align: left; text-indent: 2em;">
                                <span style="font-weight: normal; font-size: 8pt;">{{ $employees->position ?? 'n/a' }}, {{ $userId->jurisdiction->office->office_name ?? 'n/a' }}</span>
                            </div>
                        </td>
                        <td colspan="2" style="vertical-align: top; padding: 0.25em; border: none;">
                            <div style="text-align: left;">Verified by:</div>
                            <div style="text-align: left; margin-top: 4em;"></div>
                            <div style="text-align: left; text-indent: 2em;">
                                <span style="font-weight: normal; font-size: 8pt;">Signature Over Printed Name of COA Representative</span>
                            </div>
                        </td>
                    </tr>
                </tbody>
